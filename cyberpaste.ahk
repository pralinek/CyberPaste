...
Gui 1: Add, button, x215 y75 w40 h27 gpre, Menu
Gui 1: Add, button, x215 y0 w40 h27 gmoveon, Move
Gui 1: Add, button, x215 y25 w40 h27 gsplit, Split
Gui 1: Add, button, x215 y50 w40 h27 gpause, Pause


Gui 1: font, normal cwhite s12, Segoe UI 
Gui 1: Add, text, x10 y5 vText1 w200, 
Gui 1: Add, text, x10 y27 vText2 w200, 
Gui 1: Add, text, x10 y49 cgreen vVALUE vTextMain gTextmain w200,
Gui 1: font, cwhite s12, Segoe UI 
Gui 1: Add, text, x10 y75 vText4 w200, 
Gui 1:  +lastfound +AlwaysOnTop +ToolWindow -Caption 
WinSet, TransColor, color 160
;---------------------------------------------------------------------------------------------------------------------------
Gui 7: Show, x%xvar6%  y%yvar6% w40 h0.5
Gui 7: font, cwhite s12, Segoe UI
Gui 7: Add, button, x0 y0 w45 h25 gplay, Play
